      ...
      <div>
        ...
        <div className=" container p-5 lg:p-0 grid grid-cols-2 lg:grid-cols-4 gap-5 mt-10 md:mt-40">
          <div className="text-center border rounded-lg flex flex-col justify-center items-center p-5 gap-5">
            ...
            <p className="text-base font-semibold lg:text-3xl lg:font-bold">10.5k</p>
            <p className='text-xs font-normal lg:text-base'>Sellers active our site</p>
          </div>
          <div className="text-center border rounded-lg flex flex-col justify-center items-center p-5 gap-5 bg-secondary-3 text-white">
            ...
            <p className="text-base font-semibold lg:text-3xl lg:font-bold">33k</p>
            <p className='text-xs font-normal lg:text-base'>Monthly Product Sale</p>
          </div>
          <div className="text-center border rounded-lg flex flex-col justify-center items-center p-5 gap-5">
            <CustomersActive className="w-[50px] h-[50px] lg:w-20 lg:h-20" />
            <p className="text-base font-semibold lg:text-3xl lg:font-bold">45.5k</p>
            <p className='text-xs font-normal lg:text-base'>Customers active in our site</p>
          </div>
          <div className="text-center border rounded-lg flex flex-col justify-center items-center p-5 gap-5">
            <AnualGross className="w-[50px] h-[50px] lg:w-20 lg:h-20" />
            <p className="text-base font-semibold lg:text-3xl lg:font-bold">25k</p>
            <p className='text-xs font-normal lg:text-base'>Anual gross sale in our site</p>
          </div>
        </div>
